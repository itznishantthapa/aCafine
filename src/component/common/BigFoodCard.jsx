// src/component/common/BigFoodCard.jsx (updated)
...
const BigFoodCard = ({ data }) => {
  ...
  const dish = {
    id: id,
    name: title || name,
    price: price || currentPrice.toString(),
    image: image,
    ...
    <View style={styles.container}>
        ...
        <View style={styles.infoContainer}>
            ...
            <View style={styles.priceContainer}>
                <Text style={styles.price}>Rs.<Text style={styles.priceText}>{currentPrice || price}</Text></Text>
                {originalPrice && (
