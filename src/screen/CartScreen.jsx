...
const CartScreen = ({ navigation }) => {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const orderData = getOrderData('sample_esewa_transaction_id');
      
      // Here you would make the API call to create order
        ...
        <View style={styles.eatModeButtons}>
          ...
          >
            <Ionicons 
              ...
              size={20} 
              color={eatMode === 'EAT' ? '#FFFFFF' : '#333333'} 
            />
            <Text style={[styles.eatModeText, eatMode === 'EAT' && styles.selectedEatModeText]}>
              Dine In
            </Text>
          </TouchableOpacity>
          ...
          >
            <Ionicons 
              name="bag-outline" 
              size={20} 
              color={eatMode === 'PACK' ? '#FFFFFF' : '#333333'} 
            />
            <Text style={[styles.eatModeText, eatMode === 'PACK' && styles.selectedEatModeText]}>
              Takeaway
            </Text>
          </TouchableOpacity>
        </View>
